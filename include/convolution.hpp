...
public:
    ...
    ConvLayer() : input_size(0), input_ch(0), filter_size(0),
                  output_ch(0), padding(0), stride(1), output_size(0) {}
    // Méthodes
    void initialize();
...
public:
    ...
    PoolLayer() : input_size(0), input_ch(0), pool_size(0), output_size(0) {}
